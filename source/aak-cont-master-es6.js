...
var a = (function(window) {
    ...
    var aak = {
         ...
         */
        init: function(excluded, AdflyMatch, AdflyUnmatch) {
            this.$ = this.make$();
            this.config();
    ...
    aak.generic.AdflySkipper = function () {
        ...
        const handler = function (encodedURL) {
            ...
            if (decodedURL.length > 3 && decodedURL.includes(".")) {
                aak.win.stop();
                aak.win.onbeforeunload = null;
                aak.win.location.href = decodedURL;
            }
        };
        try {
            let val;
            let flag = true;
            aak.win.Object.defineProperty(aak.win, "ysmm", {
                configurable: false,
                set: function (value) {
                    if (flag) {
                        flag = false;
...
/* Website Rules (Please keep in alphabetical order.) */
